...
description: "Designs content taxonomy, navigation models, sitemap structure, and naming consistency for documentation and product surfaces."
---
...
- When naming inconsistencies accumulate across a product surface (CLI vs docs vs UI disagree on the same concept)
